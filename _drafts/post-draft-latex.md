...
Latex commands
---
1. When using \hline at adjecent rows in latex table, space can become narrow. The following user defined command can increase space in table between difference rows.


  \newcommand\Tstrut{\rule{0pt}{2.2ex}} 

Then add \Tstrut{} before line break can increase the space in between rows.
