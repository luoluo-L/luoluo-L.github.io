...
-->
  <br/><img src='/images/\blog_one_class/one_class_compare.png' width="600" title="CLR vs CLR with distribution augmentation for one-class classification problems. Bottom panel picture is from [the paper](https://arxiv.org/abs/2011.02578) and top panel is revised from that picture.">
 ...
 Details can be found in: [paper link](https://arxiv.org/abs/2011.02578),  [Paper code repo](https://github.com/google-research/deep_representation_one_class).
